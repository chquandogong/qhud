...
[GitHub Releases](https://github.com/chquandogong/qhud/releases)에서 `qhud-v0.7.1-windows-x86_64.zip`과 체크섬 파일을 받습니다. 압축을 풀고 버전명이 붙은 디렉터리 안의 `qhud.exe`를 실행합니다. Microsoft Edge WebView2 Runtime이 필요합니다.
