...
최신 다운로드는 v0.7.1입니다. `main`에는 그 뒤의 미출시 보안·저장소 운영 변경도
있습니다. 소스 상태는 [변경 이력](../CHANGELOG.md), 배포 바이너리는
[v0.7.1 릴리스 노트](05-ops/releases/v0.7.1.md)로 확인하세요. 초기 연구와 날짜별
현장 검증은 당시 범위를 그대로 유지합니다.
...
| [저장소 운영](05-ops/REPOSITORY.md) | 브랜치·태그 보호, 필수 검사, 보안 처리, 릴리스, 1인·팀·공개 운영 정책. |
| [기여 안내](../CONTRIBUTING.md) | 버그 보고, 개발 검사, 번역, 풀 리퀘스트. |
| [보안 정책](../SECURITY.md) · [지원](../SUPPORT.md) | 비공개 취약점 신고와 지원 경로. |
...
| 문서 | 다루는 내용 |
| --- | --- |
| [프로젝트 대시보드](00-overview/DASHBOARD.md) | 현재 릴리스, 날짜별 근거, 남은 검증, 백로그. |
