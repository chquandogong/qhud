...
从 [GitHub Releases](https://github.com/chquandogong/qhud/releases) 下载 `qhud-v0.7.1-windows-x86_64.zip` 及其校验和文件。解压后运行版本目录内的 `qhud.exe`。必须安装 Microsoft Edge WebView2 Runtime。
