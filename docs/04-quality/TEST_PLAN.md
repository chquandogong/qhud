<!-- qhud:languages -->
<p align="center">
  <a href="../i18n/ko/docs/04-quality/TEST_PLAN.md">한국어</a> · <strong>English</strong> · <a href="../i18n/zh-CN/docs/04-quality/TEST_PLAN.md">简体中文</a>
</p>
<!-- /qhud:languages -->
...
| Live observation      | read the startup line in the widget's stderr                                            | `live via herdr` with a pane count and no pane labels — **passed 2026-09-07** (8 panes) |
| Every provider refreshes | `qhud --refresh-all`, then read the widget's stderr                                  | all three providers answer with no error; logs contain aggregate counts only and no account IDs or usage values |
